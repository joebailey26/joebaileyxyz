...
export default ({ data, pageContext }) => {
  ...
  const nextArticle = next && (
    <Link to={"portfolio/websites/joe-bailey-xyz/" + next.slug} className="next">
  ...
  const prevArticle = previous && (
    <Link to={"portfolio/websites/joe-bailey-xyz/" + previous.slug} className="previous">
    ...
    <Layout>
      ...
      <article className="single">
        <div className="navigation">
          ...
          <span className="navIndex"><Link to="portfolio/websites/joe-bailey-xyz">Back to Index</Link></span>
        ...
        <footer>
          ...
          <Share url={site.siteUrl + '/websites/joe-bailey-xyz/' + post.slug} title={post.title} twitterHandle={site.twitterHandle}></Share>
        </footer>
        <div className="navigation">
          <span className="previous">{prevArticle}</span>
          <span className="navIndex"><Link to="portfolio/websites/joe-bailey-xyz">Back to Index</Link></span>
