...
export default ({ data, pageContext }) => {
  ...
  return (
    <Layout>
      <SEO title={post.title} slug={"/blog/" + post.slug} type="article" description={post.excerpt}/>
      <article className="single">
        ...
        <footer>
          ...
          <Share url={site.siteUrl + '/blog/' + post.slug} title={post.title} twitterHandle={site.twitterHandle}></Share>
        </footer>
        <div className="navigation">
          <span className="previous">{prevArticle}</span>
          <span className="navIndex"><Link to="blog">Back to Blog</Link></span>
