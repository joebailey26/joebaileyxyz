export default {
  ...
  head: {
    ...
    link: [
      ...
      { rel: 'preload', as: 'style', href: 'https://fonts.googleapis.com/css2?family=Rammetto+One&family=Recursive&family=Roboto+Slab:wght@400;600;700&family=Roboto:ital,wght@0,400;0,700;1,400;1,700&display=swap' },
      { rel: 'stylesheet', media: 'print', onload: 'this.media="all"', href: 'https://fonts.googleapis.com/css2?family=Rammetto+One&family=Recursive&family=Roboto+Slab:wght@400;600;700&family=Roboto:ital,wght@0,400;0,700;1,400;1,700&display=swap' }
    ],
