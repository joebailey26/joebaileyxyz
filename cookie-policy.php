...
<html lang="en-GB">
	<head>
		...
		<title>Cookie Policy | Joe Bailey | Web Designer, Developer, Photographer | Southampton, UK</title>
		...
		<link rel="canonical" href="https://joebailey.xyz/cookie-policy">
	</head>
    <body>
		<div id="joe" style="top:0px;position:absolute;"></div>
        <nav class="navbar transparent" id="transp" >
			<div class="container">
				<div class="row">
		...
		<div class="content">
			...
			<p>Third Party Analytical Cookies are prevented by default when access the site in accordance with Cookie Law. By clicking "I accept" on the Cookie Notice Banner you are agreeing to Third Party Analytical Cookies being placed on your device. If you decide to revoke your consent at a later date then see your browser Help for instructions on how to remove cookies from your machine.</p>

			<p>You can prevent the setting of ALL cookies by adjusting the settings on your browser (see your browser Help for how to do this). Be aware that disabling cookies will affect the functionality of this and many other websites that you visit. Disabling cookies will usually result in also disabling certain functionality and features of the this site. Therefore it is recommended that you do not disable cookies.</p>
			...
			<br>
			For more information on Google Analytics cookies, see the <a href="https://marketingplatform.google.com/intl/en_uk/about/analytics/">official Google Analytics page</a>.</p>

			<p>Google ReCaptcha is used on our site to prevent spam. This service sets cookies.</p>

			<p>Cloudflare is used to speed up this site. This service sets cookies.</p>
			...
			<p><b>Email: </b><a href="mailto:joe@joebailey.xyz?Subject=Cookie%20Policy" target="_top">enquiries@joebaileyphotography.com</a></p>

			<p>Last Edited 7th December 2019</p>
		</div>
